	...
	render() {
		return (
			<Comment.Group threaded style={{
				...
				<Comment>
					<Comment.Avatar as='a' src='http://react.semantic-ui.com/assets/images/avatar/small/elliot.jpg' />
					<Comment.Content>
					...
					<Comment.Group>
						<Comment>
							<Comment.Avatar as='a' src='http://react.semantic-ui.com/assets/images/avatar/small/jenny.jpg' />
							<Comment.Content>
